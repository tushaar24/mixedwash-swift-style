...
export const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" ref={sectionRef} className="bg-gray-50 py-0 md:py-[9px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header Section */}
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 mt-0 md:my-[10px]">How It Works</h2>
        </div>

...
export const HowItWorks = () => {
  ...
  return <section id="how-it-works" ref={sectionRef} className="bg-gray-50 py-16 md:py-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 mt-6 bg-blue-100 px-4 py-2 rounded-full text-blue-800 border border-blue-300">

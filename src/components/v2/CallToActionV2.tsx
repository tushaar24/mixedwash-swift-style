  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden flex items-center">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-32 right-32 w-80 h-80 bg-gray-500/15 rounded-full blur-3xl animate-bounce" style={{ animationDuration: '5s' }}></div>
        ...
        <div className="absolute bottom-40 left-60 w-1 h-16 bg-gradient-to-b from-gray-400 to-transparent opacity-40 animate-pulse transform rotate-12" style={{ animationDelay: '1s' }}></div>
      </div>
        ...
        <div className="text-center">
          ...
          <div className="relative mb-16">
            <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 flex gap-12">
              <Sparkles className="h-12 w-12 text-white animate-bounce" style={{ animationDelay: '0s' }} />
              <Zap className="h-12 w-12 text-gray-300 animate-bounce" style={{ animationDelay: '0.4s' }} />
              <Star className="h-12 w-12 text-white animate-bounce" style={{ animationDelay: '0.8s' }} />
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-16 mx-auto max-w-5xl">
              ...
              <div className="relative inline-block">
                ...
                <Button 
                  className="relative bg-gradient-to-r from-gray-900 via-black to-gray-900 hover:from-gray-800 hover:via-gray-900 hover:to-gray-800 text-white px-16 py-12 text-3xl font-black group transform hover:scale-110 transition-all duration-500 shadow-2xl border-4 border-white/30 backdrop-blur-sm rounded-3xl overflow-hidden"
              ...
              <div className="mt-8 text-gray-300 text-lg">
                <div className="flex items-center justify-center gap-2">
                  <span>Premium care for your wardrobe</span>
